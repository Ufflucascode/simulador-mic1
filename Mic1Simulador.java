...
public class Mic1Simulador {
            ...
            try {
                ...
                for(String cmd : cmds) {
                    ...
                    if(cmd.startsWith("GOTO")) {
                        ...
                        else if(op.equals("B") || op.equals("MDR") || op.equals("PC") || op.equals("MBR")) alu=1;
                    }
                }
    ...
    public void step() {
        ...
        if (ui.bBus == B_MBR && (ui.cBus & C_MDR) != 0) valB = reg.AC;
        ...
        if((ui.jam & MicroInstrucao.JMPC) != 0) {
            ...
            if(opcode == 0) next = 10;
            else if(opcode == 1) next = 20;
            else if(opcode == 2) next = 30;
            else if(opcode == 3) next = 40;
            else if(opcode == 6) next = 60;
        }
        reg.MPC = next;
    }
